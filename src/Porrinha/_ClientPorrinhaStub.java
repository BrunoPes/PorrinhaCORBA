...
public class _ClientPorrinhaStub extends org.omg.CORBA.portable.ObjectImpl implements Porrinha.ClientPorrinha
{
  ...
  public void tellPlayersNames (String[] players, int length)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                org.omg.CORBA.portable.OutputStream $out = _request ("tellPlayersNames", true);
                Porrinha.namesHelper.write ($out, players);
                ...
                tellPlayersNames (players, length        );
            } finally {
                _releaseReply ($in);
            }
  } // tellPlayersNames
  ...
  public void roundFinished (int result, int maxSum, String[] playersPicks, String[] winners)
  {
            ...
            try {
                ...
                $out.write_long (maxSum);
                Porrinha.namesHelper.write ($out, playersPicks);
                Porrinha.namesHelper.write ($out, winners);
                $in = _invoke ($out);
                return;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                ...
                roundFinished (result, maxSum, playersPicks, winners        );
            } finally {
                _releaseReply ($in);
            }
  } // roundFinished
